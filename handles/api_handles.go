...
//用户更新
func UserUpdate(DB *gorm.DB, Rdb *redis.Client)  gin.HandlerFunc {
...
//获取用户信息
func UserGet(DB *gorm.DB, Rdb *redis.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
...
//获取用户列表
func UserGetList(DB *gorm.DB, Rdb *redis.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
